---
name: draft-to-zh
description: 从 draft/<代号>/cn-article.md 生成中文文章并发布到个人博客。用户输入 "/draft-to-zh <代号>"、"发布中文版:<代号>" 或类似表述时使用。
---
...
例：`/draft-to-zh 0606tokenmaxxing`

`<代号>` 从 slash 命令参数中获取（也可用 "发布中文版:<代号>" 等自然语言触发），所有文件路径均以 `draft/<代号>/` 为根目录。
